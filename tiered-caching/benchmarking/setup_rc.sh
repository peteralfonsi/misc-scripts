...
cd opensearch-benchmark && git checkout enable-vector-search-randomization
cd /home/ec2-user
...
mv /tmp/opensearch-2.19.0-linux-x64.tar.gz /home/ec2-user
cd /home/ec2-user/
tar -zxvf opensearch-2.19.0-linux-x64.tar.gz

# fill in default parts of the opensearch config 

rm /home/ec2-user/opensearch-2.19.0/config/opensearch.yml
cat << 'EOF' >> /home/ec2-user/opensearch-2.19.0/config/opensearch.yml
